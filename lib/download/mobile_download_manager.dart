...
import 'package:fpg_family_app/download/download_manager.dart';
import 'package:fpg_family_app/entities/downloadable.dart';
...
class MobileDownloaderManager implements DownloadManager {
 // final log = Logger('MobileDownloaderManager');
  ...
  Future<String> enqueTask(String url, String downloadPath, String fileName) async {
    String? pstii = await FlutterDownloader.enqueue(
      url: url,
      savedDir: downloadPath,
      fileName: fileName,
      showNotification: true,
      openFileFromNotification: false,
      headers: {'User-Agent': "Fgp Family App"},
    );

    return pstii!.isEmpty?"":pstii.toString();
  }
